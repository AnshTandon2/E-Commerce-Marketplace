...
import java.util.Scanner;
    ...
    public class Seller {
         ...
         * Allows a seller to view the store statistics for all of their stores
         * Sorted by the number of products each customer purchased
         * And total sales for each product
         * Displays total revenue made per store and made overall by all stores
         *
         * @param userName
         */
        public static void viewStoreStatistics(String userName) {
